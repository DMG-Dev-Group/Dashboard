...
/**
 * Assistente flutuante do dashboard — disponível em qualquer tela, nos dois
 * temas (Modern/Classic usam o mesmo widget; não é uma view, é uma camada
 * por cima). Toda ação de escrita (criar projeto, lançar financeiro) pede
